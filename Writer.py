...
class Writer(object):
    ...
    def output_html_old(self):
        try:
            ...
            print("该书目录已存在".decode('utf-8'))
        i=0
        for data in self.datas:
            if os.path.exists("book/"+self.title + "/" +"%d"%data['section_title']+".txt"):
                print("book/"+self.title + "/" +"%d"%data['section_title']+".txt"+"已存在".decode('utf-8'))
                pass
            else:
                try:
                    ...
                    print("%d"%data['section_title']+"写入失败".decode('utf-8'))
                fout.close()
    ...
    def output_html(self):
        try:
            ...
            print("书包目录已存在".decode('utf-8'))
        if os.path.exists("C:/book/" + self.title + ".txt"):
            print(self.title+"已下载。。。".decode('utf-8'))
        else:
            ...
            for data in self.datas:
                try:
                    ...
                    print(self.title+"写入失败！--".decode('utf-8'))